...
def main() -> int:
    ...
    require(ROOT / "CODE_OF_CONDUCT.md", errors)
    require(ROOT / ".agents" / "skills" / "x-thread-context-capture", errors)
    require(ROOT / ".github" / "workflows" / "validate.yml", errors)
    require(ROOT / ".github" / "ISSUE_TEMPLATE" / "bug_report.yml", errors)
    require(ROOT / ".github" / "ISSUE_TEMPLATE" / "skill_improvement.yml", errors)
    require(ROOT / ".github" / "ISSUE_TEMPLATE" / "config.yml", errors)
